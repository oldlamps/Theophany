...
qrc!(my_resources,
    "ui" {
        ...
        "src/ui/components/TheophanySpinner.qml" as "components/TheophanySpinner.qml",
        ...
        "src/ui/components/Resizer.qml" as "components/Resizer.qml",
        ...
        "src/ui/dialogs/EpicInstallDialog.qml" as "dialogs/EpicInstallDialog.qml",
