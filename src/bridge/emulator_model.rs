...
impl EmulatorListModel {
    ...
    fn getSupportedPresets(&mut self) -> QString {
        let presets = r#"[
            ...
            {"name": "Microsoft Xbox (xemu)", "id": "app.xemu.xemu", "binary": "xemu", "args": "-full-screen -dvd_path %ROM%", "isRa": false, "recommendation": "<b>Recommendation:</b> The premier emulator for the original Xbox."},
            {"name": "Microsoft Xbox 360 (Xenia)", "id": "jp.xenia.xenia", "binary": "xenia,xenia_edge", "args": "%ROM%", "isRa": false, "recommendation": "<b>Recommendation:</b> The standard for Xbox 360 emulation."},
            {"name": "Sony PlayStation 4 (shadPS4)", "id": "net.shadps4.shadPS4", "binary": "shadPS4", "args": "-f %ROM%", "isRa": false, "recommendation": "<b>Recommendation:</b> A high-performance PS4 emulator currently in rapid development."},
